<?php
  ...
  */
    ...
    // Multydimensional arry
    echo '<br><br>';

    
    $m_fruits = [
        ["name" => "Pisang", "color" => "Kuning", "stock" => 20, "price" => 15000, "description" => "Pisang dengan rasa manis dan sepet"],
        ["name" => "Mangga", "color" => "Hijau", "stock" => 15, "price" => 28000, "description" => "Buah berwarna hijau yang manis"],
        ["name" => "Nanas", "color" => "Orange", "stock" => 8, "price" => 12000, "description" => "Buah tanpa dengan biji yang bisa dimakan"]
    ];
